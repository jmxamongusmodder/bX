...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		#else
		starFG = new FlxBackdrop(Paths.image('menuBooba/starFG', 'impostor'), XY, 0, 0);
		#end
		starFG.updateHitbox();
		...
		#else
		starBG = new FlxBackdrop(Paths.image('menuBooba/starBG', 'impostor'), XY, 0, 0);
		#end
		starBG.updateHitbox();
		...
		vignette.scale.set(1.23, 1.23);
		if(localFinaleState != NOT_PLAYED) vignette.visible = false;
		add(vignette);		
