...
class ShopState extends MusicBeatState
{
    ...
    var charList:Array<String> = ['none', 'biddle', 'pink', 'pip', 'idk', 'maroon', 'ghast', 'gf-farmer']; // WE'RE GONNA MAKE CHARLIST FLY!
    ...
    */
    var nodeData:Array<Dynamic> = [
        ['bottom', 'root', 'biddle', 50, false, 'Red', 'Someone kept beating cyan.', BF, COMPLETED, ['ow'], true, "Someone kept beating cyan."],
        ['bottom', 'biddle', 'pink', 100, false, 'Pink', 'A Jazzed up cook.', BF, COMPLETED, ['sauces-moogus'], true, "A Jazzed up cook."],
        ['left', 'pink', 'pip', 65, false, 'Pip', 'Chipped off the ol wood block', BF, COMPLETED, ['chippin'], true, "Chipped off the ol wood block"],
        ['left', 'cval', 'idk', 150, false, 'Soos', 'Fight off the buffest among us.', BF, COMPLETED, ['idk'], true, "Fight off the buffest among us."],
        ['top', 'root', 'maroon', 200, false, 'Maroon', 'A Ninja turned to dust.', BF, COMPLETED, ['ashes'], false, " "],
        ['top', 'maroon', 'ufo', 155, false, 'UFO', 'Aliens are not real but this thing prooves they are', PET],
        ['left', 'root', 'ghast', 50, false, 'Red', 'Something is in the lava AND ITS 95% COMPLETION', BF, PERCENT95, ['boiling-point'], true, "Something is in the lava AND ITS 95% COMPLETION"],
        ['left', 'ghast', 'gf-farmer', 250, false, 'Red', 'A Banana in a forest', GF, COMPLETED, ['posussium'], false, " "],
        ['left', 'gf-farmer', 'twitch', 75, false, 'UFO', 'Wait wait wait WHAT IS THAT', PET]
    ];
    ...
    override function create()
	{
        ...
        #else
        starsBG = new FlxBackdrop(Paths.image('shop/starBG', 'impostor'), 0, 1, false, true);
        #end
        ...
        #else
        starsFG = new FlxBackdrop(Paths.image('shop/starFG', 'impostor'), 0, 1, false, true);
        #end
